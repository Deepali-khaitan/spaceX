...
class Filter extends React.Component {
  ...
  launchClicked = (e) => {
    ...
    let filteredData = this.props.spaceXdata.filter(ele => JSON.stringify(ele.launch_success) == e.target.value)
    ...
    return (
      <div className=" box row">
        <div className="container_filter column1">
          ...
          <div className="launch">
            <div className="row">
              <div className="column" > <button type="button" value="true" onClick={e => this.launchClicked(e)} className="btn">true</button></div>
              <div className="column" > <button type="button" value="false" onClick={e => this.launchClicked(e)} className="btn">false</button></div>
            </div>
          </div>
          ...
          <div className="launch">
            <div className="row">
              <div className="column" > <button type="button" value="true" className="btn">true</button></div>
              <div className="column" > <button type="button" value="false" className="btn">false</button></div>
            </div>
          </div>
          <div>
            ...
            <div>
              ...
              <div className="spacebox1 ">{this.state.filteredData ? this.state.filteredData.map(ele => <div>
